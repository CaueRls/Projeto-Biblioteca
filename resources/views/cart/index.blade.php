...
{{-- CSS ESPECÍFICO PARA O CARRINHO --}}
<style>
    .cart-page-wrapper {
    ...
    /* SEU BOTÃO DE FINALIZAR COMPRA (PURO) */
    .btn-checkout {
        width: 100%;
    ...
    <div class="container mx-auto px-4">
        @if(session('sucesso'))
            <div class="alert-success">
                <i class="fa-solid fa-check-circle"></i> {{ session('sucesso') }}
            </div>
        @endif
            ...
            <div class="cart-grid">
                ...
                <div class="summary-column">
                    <div class="summary-card">
                        ...
                        {{-- BOTÃO PURO COM JS PARA REDIRECIONAR --}}
        ...
        @else
            <div style="text-align: center; padding: 100px 20px;">
                ...
                <a href="{{ route('home') }}" class="btn-checkout" style="max-width: 300px; margin: 0 auto; text-decoration: none;">
                    Ir para a Loja
                </a>
            </div>
        @endif
